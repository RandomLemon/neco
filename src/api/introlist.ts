  ...
  return new Promise((resolve) => {
    resolve([
      ...
      },
      {
        ...
        image: import.meta.env.BASE_URL + 'resources/restore/杜厦图书馆2.png',
      },
      {
        title: `鼓楼复原工程`,
        description: `始于2023年，主要由建筑大师黄喵和服务器管理Chino_Zhou完成。目前缺少地景和内饰，火热招募中！（请联系Stridebeach）2024年暑期社会实践校重点项目，2024年“兴泉基金”项目，毛概社会实践项目。`,
        image: import.meta.env.BASE_URL + 'resources/restore/鼓楼校区大门.png',
      },
      {
        title: `苏州复原工程`,
        description: `始于2025年，紧张筹备中。`,
        image: import.meta.env.BASE_URL + 'resources/restore/鼓楼宿舍.png',
      },
      {
        title: `VR 看校园`,
        description: `第一人称视角漫步方块校园！请关注我们的展台活动，以第一时间前来体验不一样的VR体验！`,
        image: import.meta.env.BASE_URL + 'resources/restore/大礼堂内部.png',
      },
      {
        title: `NMO 群组服务器系列`,
        description: `原版生存，模组生存，建筑，小游戏，RPG，空岛生存，Bingo……多种多样的玩法供你选择！我们的服务器由群组服及其子服和若干个独立服务器组成，详情请点击上面的菜单栏查看其它页面哦～`,
      ...
      },
      {
        ...
        image: import.meta.env.BASE_URL + `background/main-background.png`,
      },
      {
        title: `宣传美工部-动画组`,
        description: `让Minecraft的世界“生”“动”起来！NMO动画组是MUA各高校最大的Minecraft动画交流组织。精美场景渲染、超酷动画制作、相关软件教学。还有定期的“你画我猜”与贺图互换活动哦。详479223524。`,
        image: import.meta.env.BASE_URL + 'resources/groups/动画组.png',
      },
      {
        title: `运维保障部`,
